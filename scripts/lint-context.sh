...
[ -L .claude/agents/_context-agents ] || ln -sfn "$ROOT/context/agents" .claude/agents/_context-agents
[ -L .claude/commands/_context-commands ] || ln -sfn "$ROOT/context/commands" .claude/commands/_context-commands

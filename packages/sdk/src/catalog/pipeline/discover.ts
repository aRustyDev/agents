...
async function loadDiscoverSkills(): Promise<
  ...
  >
> {
  // In the monorepo, skill-discovery is at packages/cli/src/lib/skill-discovery.ts
  // Use a dynamic import with the workspace package name
  try {
...
export async function discoverRepo(
  ...
  try {
    ...
    // Discover all skills (dynamic import)

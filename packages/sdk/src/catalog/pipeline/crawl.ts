 ...
 *
 * Port of cli/crawl-registries.py -- preserves the same crawl tiers,
...
export function transformToComponent(
  ...
  if (typeof raw !== 'object' || raw === null) {
    return err(new SdkError('Expected object for component transform', 'E_TRANSFORM'))
  }
  ...
  if (!componentId) {
    return err(new SdkError('Generated empty component ID', 'E_TRANSFORM'))
  }

  ...
  subCommands: {
    ...
    add: defineCommand({
      ...
      async run({ args }) {
        ...
        const { getClientConfig } = await import('@agents/sdk/providers/clients/registry')
        ...
        const { writeServerToClient } = await import('@agents/sdk/providers/clients/config')
    ...
    list: defineCommand({
      ...
      async run({ args }) {
        const out = createOutput({ json: args.json as boolean, quiet: args.quiet as boolean })
        const { listServersInClient } = await import('@agents/sdk/providers/clients/config')
    ...
    remove: defineCommand({
      ...
      async run({ args }) {
        const out = createOutput({ json: args.json as boolean, quiet: args.quiet as boolean })
        const { removeServerFromClient } = await import('@agents/sdk/providers/clients/config')

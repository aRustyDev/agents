...
> **Note**: Replace `rust-projects` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin rust-projects

# Install dependencies
cd context/plugins/rust-projects
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp rust-projects`

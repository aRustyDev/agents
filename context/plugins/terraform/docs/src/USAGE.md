...
> **Note**: Replace `terraform` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin terraform

# Install dependencies
cd context/plugins/terraform
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp terraform`

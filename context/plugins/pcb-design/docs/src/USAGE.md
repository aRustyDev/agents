...
> **Note**: Replace `pcb-design` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin pcb-design

# Install dependencies
cd context/plugins/pcb-design
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp pcb-design`

...
> **Note**: Replace `ios-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin ios-dev

# Install dependencies
cd context/plugins/ios-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp ios-dev`

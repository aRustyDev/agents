...
> **Note**: Replace `cad-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin cad-dev

# Install dependencies
cd context/plugins/cad-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp cad-dev`

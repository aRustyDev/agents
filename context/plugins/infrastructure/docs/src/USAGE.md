...
> **Note**: Replace `infrastructure` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin infrastructure

# Install dependencies
cd context/plugins/infrastructure
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp infrastructure`

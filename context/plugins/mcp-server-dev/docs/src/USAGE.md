...
> **Note**: Replace `mcp-server-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin mcp-server-dev

# Install dependencies
cd context/plugins/mcp-server-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp mcp-server-dev`

...
> **Note**: Replace `frontend-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin frontend-dev

# Install dependencies
cd context/plugins/frontend-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp frontend-dev`

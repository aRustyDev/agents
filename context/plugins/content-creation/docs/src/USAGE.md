...
> **Note**: Replace `content-creation` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin content-creation

# Install dependencies
cd context/plugins/content-creation
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp content-creation`

...
> **Note**: Replace `model-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin model-dev

# Install dependencies
cd context/plugins/model-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp model-dev`

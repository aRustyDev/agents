...
> **Note**: Replace `api-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin api-dev

# Install dependencies
cd context/plugins/api-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp api-dev`

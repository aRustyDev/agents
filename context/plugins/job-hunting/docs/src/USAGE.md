...
> **Note**: Replace `job-hunting` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin job-hunting

# Install dependencies
cd context/plugins/job-hunting
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp job-hunting`

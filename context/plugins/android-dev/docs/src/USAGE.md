...
> **Note**: Replace `android-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin android-dev

# Install dependencies
cd context/plugins/android-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp android-dev`

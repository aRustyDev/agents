...
> **Note**: Replace `siem-ops` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin siem-ops
...
2. **Install MCP servers** (if any): `just enable-mcp siem-ops`

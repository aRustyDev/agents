...
Read the schema at `context/skills/pkgmgr-homebrew-formula-dev/scripts/formula.schema.ts` to ensure all fields are valid.

### Step 6: Render Formula

1. Locate the skill directory: `context/skills/pkgmgr-homebrew-formula-dev`

...
> **Note**: Replace `go-projects` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin go-projects

# Install dependencies
cd context/plugins/go-projects
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp go-projects`

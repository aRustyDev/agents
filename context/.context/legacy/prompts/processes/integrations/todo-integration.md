...
add_to_taskwarrior() {
  ...
  echo "✅ Added to Taskwarrior (ID: $task_id)"
}
...
add_to_github_project() {
  ...
  echo "✅ Added to GitHub Project #$project_number"
}
...
batch_add_to_todos() {
  ...
  echo "📝 Adding $count items to TODO systems: $systems"
  ...
  echo "✅ Successfully added $count items"
}
```
...
resolve_todo_conflicts() {
  ...
  ' | while read -r conflict; do
    echo "⚠️  Conflict detected for item #$(echo "$conflict" | jq -r .number)"

...
For complete implementations, see [arustydev/helm-charts](https://github.com/arustydev/helm-charts).
...
Full reference: [references/attestation-chain.md](references/attestation-chain.md)
...
Full reference: [references/atomic-releases.md](references/atomic-releases.md)
...
Full reference: [references/trust-based-auto-merge.md](references/trust-based-auto-merge.md)
...
Full reference: [references/github-app-tokens.md](references/github-app-tokens.md)
...
Full reference: [references/multi-stage-pipelines.md](references/multi-stage-pipelines.md)
...
Full reference: [references/linear-history.md](references/linear-history.md)
...
- [Attestation Chain](references/attestation-chain.md) - Cryptographic provenance
- [Atomic Releases](references/atomic-releases.md) - Per-artifact branches
- [Trust-Based Auto-Merge](references/trust-based-auto-merge.md) - CODEOWNERS + verified commits
- [GitHub App Tokens](references/github-app-tokens.md) - Elevated permissions
- [Multi-Stage Pipelines](references/multi-stage-pipelines.md) - Event-driven architecture
- [Linear History](references/linear-history.md) - Rulesets + rebase workflow

### Production Examples
- [arustydev/helm-charts](https://github.com/arustydev/helm-charts) - Complete atomic release pipeline implementation

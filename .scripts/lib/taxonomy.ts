 ...
 * Usage: bun run .scripts/lib/taxonomy.ts
 *
...
if (!fs.existsSync(TODO_PATH)) {
  ...
  console.error('Generate it first with: uv run python .scripts/generate-todo.py')
  process.exit(1)
}
...
fs.writeFileSync(
  TAXONOMY_PATH,
  `# Skill Taxonomy — auto-generated by .scripts/lib/taxonomy.ts\n# Phase 1: Rule-based classification (LLM batch fills remaining misc entries)\n# DO NOT EDIT manually — regenerate with: bun run .scripts/lib/taxonomy.ts\n\n${yamlContent}`
)

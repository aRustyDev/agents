...
- Rules in `content/rules/` are organized into category subdirectories (e.g., `pre-commit/`, `agent/`, `github/`)
- Subdirectory nesting does not affect loading — all `.md` files under `content/rules/` are discovered recursively

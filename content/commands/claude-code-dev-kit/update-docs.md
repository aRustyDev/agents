...
@/CLAUDE.md
@/docs/ai-content/project-structure.md
@/docs/ai-content/docs-overview.md
...
```text
Analysis source: [session content/commit ID/uncommitted changes]
...
2. `/docs/ai-content/project-structure.md` - **FOUNDATION:** Technology stack, complete file tree and architecture overview
3. `/docs/ai-content/docs-overview.md` - Understand:
...
2. **Update `/docs/ai-content/docs-overview.md`** to include the new file in the appropriate tier
...
#### Project Structure Updates (`/docs/ai-content/project-structure.md`)
...
Update other `/docs/ai-content/` files if changes affect:
...
- Reference the auto-loaded `/docs/ai-content/docs-overview.md`

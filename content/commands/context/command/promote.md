...
- If `context:<type>:<action>` pattern → `content/commands/<type>/<action>.md`
- If standalone → `content/commands/<name>.md`
...
/context:command:promote .claude/commands/content/plugin/validate.md
```

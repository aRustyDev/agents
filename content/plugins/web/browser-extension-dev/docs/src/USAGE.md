...
> **Note**: Replace `browser-extension-dev` with your actual plugin name throughout this document.
...
cd content/plugins/browser-extension-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp browser-extension-dev`

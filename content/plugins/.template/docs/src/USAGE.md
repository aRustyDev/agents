...
> **Note**: Replace `<plugin-name>` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin <plugin-name>

# Install dependencies
cd content/plugins/<plugin-name>
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp <plugin-name>`

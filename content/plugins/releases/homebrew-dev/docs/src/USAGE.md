...
> **Note**: Replace `homebrew-dev` with your actual plugin name throughout this document.

## Installation

```bash
# Install the plugin
just install-plugin homebrew-dev

# Install dependencies
cd content/plugins/homebrew-dev
brew bundle
```
...
2. **Install MCP servers** (if any): `just enable-mcp homebrew-dev`

...
2. If set, load persona from `content/plugins/blog-workflow/.templates/personas/<slug>.md`
...
Use template: `content/plugins/blog-workflow/.templates/research-plan.md`
...
Run checklist from `content/plugins/blog-workflow/.templates/review-checklists/research-plan.md`:
